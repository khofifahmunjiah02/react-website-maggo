            ...
            <Container style={{marginBottom:'108px'}}>
                <div style={{
                    ...
                    <div className="berita_terbaru_top">
                        <p>
                            <Row>
                            <Col xs={1} style={{ cursor: 'pointer'}} onClick={() => navigate('/Blog')}>
                                Blog &gt;
                            </Col>
                                <Col xs={7} style={{fontWeight:'bold'}}>{post.title}</Col>
                            </Row>
                             
                        </p>
                    </div>

                    <div className="berita_terbaru_deskripsi">
                    ...
                    <p style={{paddingTop:'52px', fontSize:'20px', color:'#303030'}}>
                        {post.postText}
                    </p>
